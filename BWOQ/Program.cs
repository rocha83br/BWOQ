...
namespace BWOQ
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            personList.Add(new Person { Id = 4, CreationDate = new DateTime(2014, 01, 10), DocId = "28.262.165-X", Name = "Julia dos Santos", Size = 1.60F, Height = 55, Genre = 2, Active = true, Address = new Address() { Street = "Matarazzo Street" }, Contact = new Contact() { PhoneNumber = 551135294228 } });
            ...
            var objList = bwq.Query("13>1:6>2:2").Where("8:Clara");
        }
    }
}
